...
<head>
    ...
    <title>00 Auth session CSV</title>
</head>
            ...
            <div class="exerciceHeader">
                <div class="exerciceToolbar">
                    <div class="exerciceToolbarLeftboxStorage">
                        <h1>00 Auth session CSV</h1>
                    </div>
                    <a href="<?php echo BASE_URL . "/00_AUTH_SESSION_CSV/correction/index.php" ?>" class="button">Voir la correction</a>
                </div>
            </div>
                    ...
                    <section class="exercice">
                        ...
                        <div class="exerciceboxStorage">
                            <div class="navbar">
                                ...
                                <ul>
                                    <li>
                                        <a href="<?php echo BASE_URL . "/00_AUTH_SESSION_CSV/pages/pageHome.php"; ?>">Accueil</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo BASE_URL . "/00_AUTH_SESSION_CSV/pages/pageSignUp.php"; ?>">Inscription</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo BASE_URL . "/00_AUTH_SESSION_CSV/pages/pageSignIn.php"; ?>">Connexion</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo BASE_URL . "/00_AUTH_SESSION_CSV/pages/pageAdmin.php"; ?>">Administration</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo BASE_URL . "/00_AUTH_SESSION_CSV/pages/pageSignOut.php"; ?>">Déconnexion</a>
                                    </li>
                                </ul>
                            </div>
                    </section>
