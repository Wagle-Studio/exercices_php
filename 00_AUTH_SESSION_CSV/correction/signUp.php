...
require_once PROJECT_ROOT_PATH . '/00_AUTH_SESSION_CSV/correction/class/User.php';
require_once PROJECT_ROOT_PATH . '/00_AUTH_SESSION_CSV/correction/class/Db.php';
...
if (!empty($_POST) && isset($_POST['username'], $_POST['email'], $_POST['password'], $_POST['passwordConfirm'])) {
    ...
    if ($password === $passwordConfirm) {
        ...
        $newDbConnection = new Db(PROJECT_ROOT_PATH . '/00_AUTH_SESSION_CSV/correction/db.csv');
        ...
        if ($csv !== false) {
            ...
            header("Location: " . BASE_URL . "/00_AUTH_SESSION_CSV/correction/index.php?successSignUp=1");
        ...
        header("Location: " . BASE_URL . "/00_AUTH_SESSION_CSV/correction/index.php?successSignUp=0");
