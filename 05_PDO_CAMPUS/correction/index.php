...
<head>
    ...
    <title>05 PDO Campus - correction</title>
</head>
            ...
            <div class="exerciceHeader">
                <div class="exerciceToolbar">
                    <div class="exerciceToolbarLeftboxStorage">
                        <h1>05 PDO Campus - correction</h1>
                    </div>
                    <a href="<?php echo BASE_URL . "/05_PDO_CAMPUS/index.php"; ?>" class="button">Revenir à l'exercice</a>
                </div>
                <div>
