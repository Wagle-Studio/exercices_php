...
<section class="exercice">
    ...
    <div class="exerciceboxStorage">
        <?php include PROJECT_ROOT_PATH . "/00_CRUD_CSV/correction/templates/components/toast.php" ?>
        <div class="exerciceBoxStorageToolbar">
            <a class="button--small" href="<?php echo BASE_URL . "/00_CRUD_CSV/correction/templates/pages/create.php"; ?>">Créer un utilisateur</a>
        </div>
            ...
            <table class="exerciceBoxStorageBodyTable">
                ...
                <tbody>
                    ...
                    foreach ($users as $user) {
                        $editUrl = BASE_URL . "/00_CRUD_CSV/correction/templates/pages/edit.php?id=" . urlencode($user->getId());
                        $deleteAction = BASE_URL . "/00_CRUD_CSV/correction/src/treatments/deleteUser.php";
