...
if (empty($_POST) || !isset($_POST, $_POST["userId"], $_POST["email"], $_POST["password"])) {
    header("Location: " . BASE_URL . "/00_CRUD_CSV/correction/index.php?editUser=unprocessable");
    exit;
}
...
if (!$updateUserSucces) {
    header("Location: " . BASE_URL . "/00_CRUD_CSV/correction/index.php?editUser=error");
    exit;
}

header("Location: " . BASE_URL . "/00_CRUD_CSV/correction/index.php?editUser=success");
exit;
