...
if (empty($_POST) || !isset($_POST["userId"])) {
    header("Location: " . BASE_URL . "/00_CRUD_CSV/correction/index.php?deleteUser=unprocessable");
    exit;
}
...
if (!$deleteSuccess) {
    header("Location: " . BASE_URL . "/00_CRUD_CSV/correction/index.php?deleteUser=error");
    exit;
}

header("Location: " . BASE_URL . "/00_CRUD_CSV/correction/index.php?deleteUser=success");
exit;
