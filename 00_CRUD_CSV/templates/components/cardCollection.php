...
<section class="exercice">
    ...
    <div class="exerciceboxStorage">
        <?php include PROJECT_ROOT_PATH . "/00_CRUD_CSV/templates/components/toast.php" ?>
        <div class="exerciceBoxStorageToolbar">
            <a class="button--small" href="<?php echo BASE_URL . "/00_CRUD_CSV/templates/pages/create.php"; ?>">Créer un utilisateur</a>
        </div>
