...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL . "/00_DIVERS/assets/styles.css" ?>" />
    <title>00 Divers - correction</title>
</head>
            ...
            <div class="exerciceHeader">
                <div class="exerciceToolbar">
                    <div class="exerciceToolbarLeftboxStorage">
                        <h1>00 Divers - correction</h1>
                    </div>
                    <a href="<?php echo BASE_URL . "/00_DIVERS/index.php"; ?>" class="button">Retour à l'exercice</a>
                </div>
            </div>
