...
if (empty($_POST || !isset($_POST, $_POST["email"], $_POST["password"]))) {
    header("Location: " . BASE_URL ."/03_CRUD_CSV/correction/index.php?createUser=unprocessable");
    exit;
}
...
if (!isset($stream) || $stream == false) {
    header("Location: " . BASE_URL ."/03_CRUD_CSV/correction/index.php?createUser=streamError");
    exit;
}
...
header("Location: " . BASE_URL ."/03_CRUD_CSV/correction/index.php?createUser=success");
exit;
