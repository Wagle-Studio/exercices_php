        ...
        <article class="exercicePlayground">
            <div class="exerciceHeader">
                <div class="exerciceToolbar">
                    ...
                    <a href="<?php echo BASE_URL . "/03_CRUD_CSV/correction/index.php"; ?>" class="button">Voir la correction</a>
                </div>
            </div>
            <ul class="exerciceList">
                <li>
                    <?php
                    include PROJECT_ROOT_PATH . "/03_CRUD_CSV/templates/components/cardCollection.php";
                    ?>
                </li>
            </ul>
        </article>
