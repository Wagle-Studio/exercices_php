...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL . "/02_AJAX/assets/style.css"; ?>">
    <title>02 Ajax - correction</title>
</head>
            ...
            <div class="exerciceHeader">
                <div class="exerciceToolbar">
                    <div class="exerciceToolbarLeftboxStorage">
                        <h1>02 Ajax - correction</h1>
                    </div>
                    <a href="<?php echo BASE_URL . "/02_AJAX/index.php"; ?>" class="button">Retour à l'exercice</a>
                </div>
            </div>
